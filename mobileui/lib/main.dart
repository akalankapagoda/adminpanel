...
/// A sample class to observe and print bloc events for debugging purposes
...
void main() async {
  ...
  final config = await AppConfig.forEnvironment(
      'dev'); // TODO: Get the environment from an argument
...
class App extends StatefulWidget {
  ...
  App({Key key, @required this.tokenRepository, @required this.config})
      : super(key: key);
...
class _AppState extends State<App> {
  ...
  void initState() {
    ...
    userRepository = new UserRepository(
        config: widget.config, tokenRepository: tokenRepository);
    userListBloc = new UserListBloc(
        ...
        home: BlocBuilder<AuthenticationBloc, AuthenticationState>(
          ...
          builder: (BuildContext context, AuthenticationState state) {
            authenticationBloc.context =
                context; // Set context to help with navigation
